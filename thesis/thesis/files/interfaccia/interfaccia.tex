...
Una pagina simile viene mostrata nel caso in cui l'applicazione non riesce a connettersi al database di AirQino (ad esempio se è in fase di mantenimento).
