...
\caption{Una centralina AirQino\\Fonte: \url{airqino.magentalab.it}}
\label{fig:smart72}
\end{figure}
...
\caption{Centralina ARPAT in sede Capannori (provincia di Lucca)\\Fonte: \url{arpat.toscana.it}}
\label{fig:capannori}
\end{figure}
...
Il dataset di misurazioni \ce{NO2}, comprende sia i dati della centralina AirQino SMART16 che i dati di ARPAT (Capannori). Ci sono però delle differenze sostaziali tra i due set di dati:\\
...
\begin{figure}[H]%
    \centering
    \captionsetup{justification=centering}
    \subfloat[\centering Frequenza di misurazione]{{\includegraphics[width=7.3cm]{img/smart16_count} }}%
    \subfloat[\centering Andamento (in \textit{counts})]{{\includegraphics[width=7.3cm]{img/smart16_no2} }}%
...
\begin{figure}[H]%
    \centering
    \captionsetup{justification=centering}
    \subfloat[\centering Andamento \ce{PM_{2.5}} (in µg/m³)]{{\includegraphics[width=7.3cm]{img/smart16_new_pm2.5} }}%
    \subfloat[\centering Andamento \ce{PM_{10}} (in µg/m³)]{{\includegraphics[width=7.3cm]{img/smart16_new_pm10} }}%
...
\begin{figure}[H]%
    \centering
    \captionsetup{justification=centering}
    \subfloat[\centering Andamento \ce{PM_{2.5}} (in µg/m³)]{{\includegraphics[width=7.3cm]{img/lu-capannori_pm_dati_orari_cleaned_pm2.5} }}%
    \subfloat[\centering Andamento \ce{PM_{10}} (in µg/m³)]{{\includegraphics[width=7.3cm]{img/lu-capannori_pm_dati_orari_cleaned_pm10} }}%
