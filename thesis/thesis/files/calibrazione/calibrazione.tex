...
I dataset sono stati collezionati nel periodo 01/01/2020 - 20/11/2021 di colocazione di SMART16 con la stazione ARPAT di Capannori (Lucca).\\
...
Il dataset di misurazioni \ce{NO2} di AirQino è stato ottenuto con delle query specifiche sul database.
I dati ARPAT (Capannori) per il confronto invece sono messi a disposizione sul sito ufficiale \cite{arpat} e sono accessibili tramite API, a seguito di un periodo di validazione che può durare anche diversi mesi.
