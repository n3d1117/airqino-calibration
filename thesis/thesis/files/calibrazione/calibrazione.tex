...
\includegraphics[width=0.5\textwidth]{img/res_no2_scatter}%
}\hfil
\subfloat[Plot]{%
\includegraphics[width=0.5\textwidth]{img/res_no2_plot}%
}

\subfloat[Distribuzione]{%
\includegraphics[width=0.5\textwidth]{img/res_no2_distr}%
}\hfil
\subfloat[Q-Q plot]{%
\includegraphics[width=0.5\textwidth]{img/res_no2_qq}%
}
\caption{Analisi dei residui dataset \ce{NO2}}
\end{figure}


% risultati su tutto l’anno
risultati su tutto l’anno:
\begin{table}[H]
    \footnotesize
    \centering
...
\begin{figure}[H]%
    \centering
    \captionsetup{justification=centering}
    \subfloat[\centering $\mathrm{R^2}$]{{\includegraphics[width=6.9cm]{img/hist_no2_1} }}%
    \subfloat[\centering RMSE]{{\includegraphics[width=6.9cm]{img/hist_no2_2} }}%
...
\end{table}
\footnotetext{Con riferimento ad una equazione del tipo $y=a+bx+cx^2+dx^3+ex^4$}
