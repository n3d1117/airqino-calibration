...
Nella figura \ref{fig:smart16-no2} viene riportato l'andamento della concentrazione di \ce{NO2} nell'ambiente (in \textit{counts}) misurata dalla centralina SMART16 nel periodo di interesse (dal 01/01/2020 al 31/12/2020).
...
\caption{Andamento \ce{NO2} (in µg/m³) misurato dalla stazione ARPAT di Capannori nel periodo dal 01/01/2020 al 31/12/2020}
\label{fig:arpat-no2}
\end{figure}
...
Nella figura \ref{fig:smart16-pm} sono riportati gli andamenti della concentrazione di \ce{PM_{2.5}} e \ce{PM10} nell'aria (in µg/m³) misurati dalla centralina SMART16 nel periodo di interesse (dal 01/09/2020 al 31/08/2021).
...
\begin{itemize}
  \item \textbf{Scatterplot} preliminare delle misurazioni AirQino confrontate con le misurazioni di riferimento ARPAT, per individuare relazioni tra le variabili. Questo perché in generale ci si aspetta che la risposta del sensore sia lineare all'aumentare delle concentrazioni e correlata al segnale di riferimento;
