...
I principali inquinanti atmosferici sono l'ossido di zolfo (\ce{SO_{x}}), ossido di azoto (\ce{NO_{x}}), monossido di carbonio (\ce{CO}), ozono (\ce{O_{3}}) e particolato atmosferico (\ce{PM}).
