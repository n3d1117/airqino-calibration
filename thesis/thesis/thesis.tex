...
% Frontespizio -------------------------------------------------------------------
       ...
       \correlatori{Dott. Walter Nunziati\\Dott.ssa Alice Cavaliere} % i correlatori separati da \\
...
\lstdefinelanguage{js}{
  keywords={break, case, catch, continue, do, else, finally, for, function, if, in, instanceof, new, return, switch, this, throw, try, typeof, var, void, while, with, export},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
